...
* Frontend shall match provided HTML/CSS/JS files as closely as possible
  ...
  * Checkout
    ...
    * *TODO* Make Stripe work, with correct pricing
...
* Admin:
  ...
  * Thumbnails and watermarks are automatically generated upon upload
    ...
    * *TODO* Two "full resolution" sizes are needed, one largest and more-expensive "commercial" size, and a smaller cheaper "personal use" size. (Four total image types: original full-res (commercial use); smaller res (personal use); watermark; thumbnail)
      * *TODO* Pricing for commercial and personal sizes should be editable in admin settings.
      * *TODO* Customer should be able to purchase either commercial or personal use sizes and receive only that size on checkout.
...
1. Commercial vs personal image sizes & prices
1. Cart issues
