...
* Admin:
  ...
  * *TODO* Other tags should be auto-generated:
    ...
    * *TODO* Copyright (always just "DHPA")
...
1. EXIF parsing ("people" is inputted on a per-event basis but displayed on a per-photo basis and is null.)
  * https://github.com/janfri/mini_exiftool/blob/master/lib/mini_exiftool.rb
