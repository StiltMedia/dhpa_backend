...
1. When a photo has names which are missing (indicated by "No ID"), visitors should be able to click a "Whats my Name" link under a photo to provide the Admin the missing name - like http://www.patrickmcmullan.com/whoami/index.aspx
