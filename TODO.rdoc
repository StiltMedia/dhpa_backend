...
* Frontend shall match provided HTML/CSS/JS files as closely as possible
  ...
  * Picture Detail
    ...
    * *TODO* Completely remove the digital/physical, license, and nationality options from the detail page -- make those properties blank across the GUI as well (i.e. during checkout)
  * *TODO* Shopping Cart
...
1. Verify image upload functionality on test server
