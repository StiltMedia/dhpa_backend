...
* Admin:
  ...
  * *TODO* Thumbnails and watermarks should be automatically generated upon upload
    * *TODO* Watermark should be similar to BFA.com: a semitransparent gray square with image ID and the website logo overlaid over about a quarter of the image.
    ...
    * *TODO* No watermark will be applied to full-resolution image or thumbnail (three total image types: original full-res; watermark; thumbnail)
...
* All users:
  ...
  * *VERIFY* Not able to view or download full-resolution images unless they have purchased them
