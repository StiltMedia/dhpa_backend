...
* Hourly
  1. x About page images missing - http://fox.dhpa.staging.c66.me/about
  1. x When user is in an event - http://fox.dhpa.staging.c66.me/events/high-life-2016  - and can see the names of people tagged, I should be able to click on the name (same results as if I search their name)
