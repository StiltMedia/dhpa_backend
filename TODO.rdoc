...
* Frontend shall match provided HTML/CSS/JS files as closely as possible
  * Home
    * *QUESTION* We're using a slideshow plugin for the LEARN MORE photo, is this right?
    * *TODO* There's no photos/events/refine control on the home search form
    * *QUESTION* Will event images always be landscape? Portrait images might not look good on the homepage.
  ...
  * Picture Detail
  * *TODO* Shopping Cart
    * QUESTION* There are three different license types and also Nationality, is this right? (Web Editorial, Print, Web and Print); Nationality (National/International)
  ...
  * *QUESTION* The design has a "featured content" area, this isn't coded..?
  * Register/Log in
* Admin:
