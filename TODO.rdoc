...
* Frontend shall match provided HTML/CSS/JS files as closely as possible
  ...
  * *TODO* Shopping Cart
    * *QUESTION* Is any sort of add-to-cart indication necessary? Add To Cart doesn't really show what's been done.
  * Checkout
    * Global pricing
...
* Admin:
  ...
  * *TODO* Admin should be able to edit the commercial/personal default prices for images in one place. Admin can override the default commercial/personal pricing on a per-image basis as well.
* Unregistered User:
...
* All users:
  ...
  * Not able to view or download full-resolution images unless they have purchased them
    ...
    * *TODO* Will NOT be able to “right click > save” any unpurchased photos
    * *TODO* Will NOT be able to “drag and drop” any unpurchased photos
...
1. Custom pricing should be commercial/personal as well, not just one custom price
1. Ability to mark albums as private
1. General "keywords" for image search
1. Search should work
1. Disable right-click and drag-drop
1. Admin should be able to mark albums as private (by assignment to other users, or by a password)
1. Verify that registered users can see their purchases
1. Registered user wishlists
...
1. Contact form should work
  1. https://rubyonrailshelp.wordpress.com/2014/01/08/rails-4-simple-form-and-mail-form-to-make-contact-form/
1. Picture detail should match design
