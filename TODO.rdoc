...
* Hourly
  1. if the page is blank, footer should be at the bottom; if the page is long....i should scroll to bottom then see footer.
  ...
  1. write a sentence / make a note on the purchase page that if people / clients want to order prints to email me at support@dhpa.com. 
  1. other photographers can sign in and upload photos (subadmin accounts with add/edit events/photo privileges only - no orders, info, etc)
  ...
  1. Ensure purchase page shows image number, credit card number, receipt / invoice number, etc. 

  1. people / clients can pay with their credit card AND pay pal accounts. (this is out of scope so please quote first)